...
//   Assignment 1
  const californiaStudents = utme2024Students.filter(student => student.state === "California");
...
//   Assignment 4
const totalScores = utme2024Students.reduce((accumulator, student) => accumulator + student.score, 0);
const averageScore = totalScores / utme2024Students.length;
